...
from .components import ConfigurationPanel, ProgressTab, ResultsTab, LogTab
...
class MarketMinerGUI:
    ...
    def start_scraping(self):
        ...
        try:
            ...
            if max_threads < 1 or max_threads > 20:
    ...
    def scrape_worker(self):
        ...
        try:
            ...
            output_file = self.config_panel.output_file_var.get()
